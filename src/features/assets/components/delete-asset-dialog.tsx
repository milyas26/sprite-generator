    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-sm border-0 bg-[#2e2833] p-0 gap-0 overflow-hidden" showCloseButton={false}>
        <div className="flex items-start gap-3 p-5">
          ...
          <div>
            <DialogTitle className="font-mono text-sm text-foreground uppercase tracking-wider mb-1">Delete Asset</DialogTitle>
            <DialogDescription className="text-[11px] text-muted-foreground font-mono">
              Permanently delete <span className="text-foreground font-semibold">&quot;{assetName}&quot;</span>? All DNA data and generation history will be removed.
            </DialogDescription>
          </div>
        </div>
