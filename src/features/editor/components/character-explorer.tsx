...
export function CharacterExplorer({
  ...
  return (
    <div className="flex flex-col h-full bg-[#0d0d14] border-r border-border">
      ...
      <div className="px-2 py-1.5 space-y-1 shrink-0">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-6 h-7 bg-[#0a0a12] border-border text-foreground placeholder:text-muted-foreground/30 font-mono text-[10px] focus:border-primary/40"
          />
        </div>
        <Button
          size="xs"
            ...
            {filtered.map((character) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "border border-transparent hover:bg-[#12121e] hover:border-border/40"
                  )}
                ...
                >
                  ...
                  <div className="flex items-center justify-center w-6 h-6 rounded bg-[#0a0a10] border border-border/30 flex-shrink-0 overflow-hidden">
                    {character.sheetUrl ? (
